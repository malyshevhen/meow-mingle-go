...
type IPostRepository interface {
	...
	GetPost(ctx context.Context, id int64) (post Post, err error)
	GetFeed(ctx context.Context, userId int64) (feed []Post, err error)
	ListUserPosts(ctx context.Context, userId int64) (posts []Post, err error)
...
func (pr *PostRepository) GetPost(ctx context.Context, id int64) (post Post, err error) {
	return pr.GetById(ctx, getPostCypher, id)
}

func (pr *PostRepository) GetFeed(ctx context.Context, userId int64) (feed []Post, err error) {
	return pr.List(ctx, listFeed, userId)
}

func (pr *PostRepository) ListUserPosts(ctx context.Context, userId int64) (posts []Post, err error) {
...
func (pr *PostRepository) DeletePost(ctx context.Context, userId, postId int64) error {
