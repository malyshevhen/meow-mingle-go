...
func (s *SQLStore) DeleteSubscriptionTx(
	ctx context.Context,
...
func (s *SQLStore) CreateCommentTx(
	ctx context.Context,
...
func (s *SQLStore) UpdateCommentTx(
	ctx context.Context,
	userId int64,
...
func (s *SQLStore) CreateCommentLikeTx(
	ctx context.Context,
	params CreateCommentLikeParams,
) (err error) {
...
func (s *SQLStore) isCommentsAuthor(
	ctx context.Context,
	commentId int64,
	userId int64,
) (error, bool) {
